  ...
  return (
    <div className="agent_client_details_container">
      ...
      <div className="agent_client_details_header">
        <h2 className="agent_client_details_title">CLIENT DETAILS</h2>
      </div>
        ...
        <table className="agent_client_details_table">
          ...
          <tbody>
            <tr>
              ...
              <td>
                <span className="agent_client_details_action_icon"><FaEdit /></span>
                <span className="agent_client_details_action_icon"><FaTrash /></span>
              </td>
            </tr>
            <tr>
              <td>Maria Santos</td>
