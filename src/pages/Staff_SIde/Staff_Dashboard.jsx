...
const Staff_Dashboard = () => {
  ...
  return (
    <div className="staff_dashboard_container">

      {/* Main Content */}
      <main className="staff_dashboard_main">

        {/* Add Listing Button */}
        <div className="staff_dashboard_actionbar">
          <button className="staff_dashboard_addBtn">ADD LISTING</button>
        </div>

        {/* Table */}
        <div className="staff_dashboard_table_wrapper">
            ...
            <tbody>
              {data.map((row, index) => (
                <tr key={index}>
                  ...
                  <td>{row.image}</td>
                  <td>
                    <button className="staff_dashboard_iconBtn"><FaEdit /></button>
                    <button className="staff_dashboard_iconBtn"><FaTrash /></button>
                  </td>
                </tr>
              ))}
            </tbody>
